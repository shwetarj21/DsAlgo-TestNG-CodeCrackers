...
public class Queue_PageFactory extends BaseClass {
	...
	TryEditor readTryEditor = new TryEditor();
        ...
        @FindBy(xpath="//h4[@class='bg-secondary text-white']") WebElement Queuetitle;
		...
		@FindBy(xpath="//p[normalize-space()='Implementation of Queue in Python']") WebElement implementationofqueuetitle;
		@FindBy(xpath="//p[normalize-space()='Implementation using collections.deque']") WebElement implementationcollectiontitle;
		@FindBy(xpath="//p[normalize-space()='Implementation using array']") WebElement implementationusingarraytitle;
		@FindBy(xpath="//p[normalize-space()='Queue Operations']") WebElement queueoperationstitle;
        ...
        @FindBy(xpath = "//a[normalize-space()='Search the Queue']")WebElement queuepq;
